...
insert into korisnik (grad,ime,password,email,prezime,broj_telefona,role,username, jedinstveni_broj, drzava, adresa) VALUES (NULL,'janko','$2a$10$PyUWKQye6ObdS417LOa08u.rmr.ms7lZ7y5JlQ52PfWE16.uraAHC',NULL,NULL,0,'REGISTROVAN','janko',55,'srbija','njegoseva');
...
insert into klinika (ime, adresa, opis) values ('Vojna','Drenovik','Vojna klinika');
